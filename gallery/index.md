...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 px-4 py-8 bg-[#0b0c10]">
  {% for item in sorted_gallery %}
    <div>
      ...
      <h2 class="text-xl mt-2 font-semibold text-white">{{ item.title }}</h2>
...
<div id="lightbox" class="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center hidden z-50">
  ...
  <img id="lightbox-img" src="" alt="" class="max-w-3xl w-full h-auto">
