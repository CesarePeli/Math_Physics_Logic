...
The earliest surviving systematic presentation of mathematical demonstration in the Greek tradition is Euclid's Elements (around 300 BC), followed by the geometric works of Archimedes (c. 287–212 BC) and Apollonius of Perga (c. 240–190 BC).

Aristotle (384–322 BC), especially in the Prior Analytics and Posterior Analytics, developed a general theory of deductive reasoning and scientific demonstration.

Modern mathematics and philosophy have identified errors, implicit assumptions, and gaps in these ancient works. Even so, they remained points of reference for more than two thousand years and decisively shaped Western conceptions of rationality.
...
<figure style="text-align: center; margin: 2rem auto;">
  ...
  <figcaption style="margin-top: 0.75rem;">
    The diagram known in China as <em>hsuan-thu</em>.
  </figcaption>
</figure>
...
<figure style="text-align: center; margin: 2rem auto;">
  ...
  >
  <figcaption style="margin-top: 0.75rem;">
    A rearrangement proof of the Pythagorean theorem.
  </figcaption>
</figure>
